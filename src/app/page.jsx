...
const Hero = () => {
  return (
    <>
      ...
      <section id="pricing" className="pricing-section flex flex-col justify-center items-center mx-auto w-full px-6 md:px-11 max-w-6xl pt-14 pb-20 overflow-hidden gap-12 lg:gap-8">
        <PricingSection />
      </section>
